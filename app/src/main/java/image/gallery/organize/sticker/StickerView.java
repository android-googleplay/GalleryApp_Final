...
public class StickerView extends FrameLayout {
  ...
  public StickerView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    try {
      ...
      borderPaint.setColor(a.getColor(R.styleable.StickerView_borderColor, getResources().getColor(R.color.colorPrimary)));
  ...
  public void configDefaultIcons() {
    BitmapStickerIcon deleteIcon = new BitmapStickerIcon(
        ContextCompat.getDrawable(getContext(), R.drawable.ic_sticker_close),
  ...
  /**
   * StickerPhoto's drawable will be too bigger or smaller
