...
public class TextSticker extends Sticker {
    ...
    /**
     * Upper bounds for edit_image_text_beo size.
     * This acts as a starting point for resizing.
     */
    private float maxTextSizePixels;

    /**
     * Lower bounds for edit_image_text_beo size.
     */
    ...
    public TextSticker(@NonNull Context context, @Nullable Drawable drawable) {
        ...
        if (drawable == null) {
            this.drawable = ContextCompat.getDrawable(context, R.drawable.sticker_transparent_bg);
        }
    ...
    @NonNull
    public TextSticker setTextTexture(@Nullable Shader shader) {
        textPaint.setShader(shader);
        return this;
    }

    @NonNull
    public TextSticker set3d(@Nullable float radius, float dx, float dy, int color) {
    ...
    /**
     * Sets the lower edit_image_text_beo size limit
     *
     * @param minTextSizeScaledPixels the minimum size to use for edit_image_text_beo in this view,
     *                                in scaled pixels.
     */
    @NonNull
    ...
    /**
     * Resize this view's edit_image_text_beo size with respect to its width and height
    ...
    public TextSticker resizeText() {
        ...
        // Safety check
        // (Do not resize if the view does not have dimensions or if there is no edit_image_text_beo)
        if (text == null
                || text.length() <= 0
        ...
        // or we have reached our minimum edit_image_text_beo size,
        ...
        // If we have reached our minimum edit_image_text_beo size and the edit_image_text_beo still doesn't fit,
        // append an ellipsis
        ...
        if (targetTextSizePixels == minTextSizePixels
            ...
            // Check that we have a least one line of rendered edit_image_text_beo
    ...
    /**
     * @return lower edit_image_text_beo size limit, in pixels.
     */
    ...
    /**
     * Sets the edit_image_text_beo size of a clone of the view's {@link TextPaint} object
     * and uses a {@link StaticLayout} instance to measure the height of the edit_image_text_beo.
     *
     * @return the height of the edit_image_text_beo when placed in a view
     * with the specified width
     * and when the edit_image_text_beo has the specified size.
     */
