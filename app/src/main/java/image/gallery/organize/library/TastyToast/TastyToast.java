package image.gallery.organize.library.TastyToast;
...
public class TastyToast {
    ...
    public static Toast makeText(Context context, String msg, int length, int type) {
        ...
        switch (type) {
            case 1: {
                View layout = LayoutInflater.from(context).inflate(R.layout.toast_success, null, false);
            ...
            case 2: {
                View layout = LayoutInflater.from(context).inflate(R.layout.toast_warning, null, false);
                ...
                t.start();
                text.setBackgroundResource(R.drawable.toast_warning);
                text.setTextColor(Color.parseColor("#FFFFFF"));
                toast.setView(layout);
                break;
            }
            case 3: {
                View layout = LayoutInflater.from(context).inflate(R.layout.toast_error, null, false);
            ...
            case 4: {
                View layout = LayoutInflater.from(context).inflate(R.layout.toast_info, null, false);
            ...
            case 5: {
                View layout = LayoutInflater.from(context).inflate(R.layout.toast_default, null, false);
            ...
            case 6: {
                View layout = LayoutInflater.from(context).inflate(R.layout.toast_confusing, null, false);
